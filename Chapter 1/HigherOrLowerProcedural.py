...
print('You have to choose whether the next card to be shown will be higher or lower than the curr0ent card.')
...
for suit in SUIT_TUPLE:
    ...
    while True:  # play multiple games
        ...
        for card_number in range (0, NUMBER_OF_CARDS):  # play one game of this many cards
            answer = input(f'Will the next card be higher or lower than the {current_card_rank} of '
                           f'{current_card_suit}? (enter h or l): ').lower()
